CREATE TABLE public.temporal_index (
	id_resource text NULL,
	interval_start date NULL,
	interval_end date NULL,
	package_id text NULL,
	num_resources_package int4 NULL
);


CREATE INDEX idx_temporal_index_id_resource 
ON temporal_index(id_resource);
